...
const AppConfig = () => {
  return {
    ...
    twitter: 'https://twitter.com/danny_nkjg',
    ...
    description:
      ...
      'A content creation framework for rapidly building beautiful and expressive web applications.',
    ...
    /*
        ...
        |
        */
    repository: 'https://github.com/DGeisz' || process.env.NEXT_PUBLIC_APP_REPOSITORY || '',
