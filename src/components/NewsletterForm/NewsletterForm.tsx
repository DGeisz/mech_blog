interface Props {
  /**
   * An action url string, where data should be posted
   */
  action: any
}

/**
 * @returns A newsletter signup form, with an email address input
 */
export const NewsletterForm = ({ action }: Props) => {
  return (
    <form action={action} method="post" target="_blank" className="flex flex-wrap -mx-2">
